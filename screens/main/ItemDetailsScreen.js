      ...
      >
        ...
        <View style={styles.marketValueCard}>
          <View style={styles.marketValueHeader}>
            <Ionicons name="trending-up" size={20} color={colors.textBase} />
            <Text style={styles.marketValueTitle}>Market Value</Text>
          </View>
          ...
          <View style={styles.marketValueBar}>
            <View
              style={[
                ...
                {
                  width: `${Math.min(100, 60 + (antique.market_value_min ?? 0) / 20)}%`,
                },
              ]}
            />
          </View>
