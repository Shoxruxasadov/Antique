...
const GOOD_IMAGE = require('../../assets/scanner/Group 1.png');
const BAD_IMAGES = [
  require('../../assets/scanner/Group 2.png'),
  require('../../assets/scanner/Group 3.png'),
];
...
function TipCircle({ source, isGood, label, size }) {
  return (
